...
- **Security Tests:** Added `test_loadFen_invalid` to verify that the FEN parser handles malformed inputs gracefully without crashing (e.g., buffer overflows, invalid piece counts, malformed clocks).
